...
pub struct OsuPerformance<'map> {
    ...
    //combo consistency v3 not og akatsuki pp rs; 
...
impl OsuPerformanceInner<'_> {
    ...
    fn compute_flashlight_value(&self) -> f64 {
        ...
        let inner = OsuPerformanceInner {
            ...
            state: self.state,
            effective_miss_count: self.effective_miss_count,
            using_classic_slider_acc: self.using_classic_slider_acc,
            disable_combo_scaling: self.disable_combo_scaling,
            combo_consistency_v3_p: self.combo_consistency_v3_p,
        };
    ...
    if self.combo_consistency_v3_p.is_some() {
        pp *= self.apply_cc_v3_multiplier();
    }
}
